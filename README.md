...
4. Consider caching posts in a database server (50% done, mongoose installed).
5. Extend access token validity (Need to persist user access tokens on database, 60% done).
